package com.brockw.stickwar.engine.multiplayer
{
   ...
   public class MainLobbyScreen extends Screen
   {
      ...
      private function campaignButton(param1:Event) : void
      {
         ...
         file.browse([new FileFilter("SE Replays","*.replay","*")]);
      }
      ...
      public function onComplete(evt:Event) : void
      {
         ...
         if((_loc4_ = _loc3_.gameReplay.fromString(file.data)) && _loc3_.gameReplay.version == Main(this.main).version)
         {
            Main(this.main).replayGameScreen.replayString = file.data;
            trace("PLS WORK");
