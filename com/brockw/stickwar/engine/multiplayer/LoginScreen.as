package com.brockw.stickwar.engine.multiplayer
{
   ...
   public class LoginScreen extends Screen
   {
      ...
      private var did:Boolean = false;
      
      private var remState:int = 0;
      
      private var remtext:TextField;
      ...
      private function update(param1:Event) : void
      {
         ...
         if(this.loginMc.connectingMc.visible == false && !did && accSaveExists())
         {
            load();
            did = true;
         }
      ...
      override public function enter() : void
      {
         ...
         this.loginMc.forgotPasswordButton.alpha = 0;
         ...
         if(this.remtext == null)
         {
            this.remtext = createTextField(200,35,12,"#ff9900");
            remtext.htmlText = "<p align=\"left\"><font size=\'12\' color=\"#999999\">Remember Me - </font><font size=\'12\' color=\"#FF0000\">No</font></p>";
         }
      }
      ...
      private function openForgotPassword(:Event) : void
      {
         var text:String = "remember";
         if(remState == 0)
         {
            text = "<p align=\"left\"><font color=\"#999999\" size=\'12\'>Remember Me - </font><font size=\'12\' color=\"#FFBB00\">Yes</font></p>";
            remState = 1;
         }
         else if(remState == 1)
         {
            text = "<p align=\"left\"><font color=\"#999999\" size=\'12\'>Remember Me - </font><font size=\'12\' color=\"#00FF00\">Yes & Login</font></p>";
            remState = 2;
         }
         else if(remState == 2)
         {
            text = "<p align=\"left\"><font color=\"#999999\" size=\'12\'>Remember Me - </font><font size=\'12\' color=\"#FF0000\">No</font></p>";
            remState = 0;
         }
         remtext.htmlText = text;
         param1 = SharedObject.getLocal("stickempiresAcc");
         param1.data.remstate = this.remState;
      }
      
      public function createTextField(width:Number, height:Number, fontSize:int, color:String) : TextField
      {
         var textField:TextField = new TextField();
         textField.width = width;
         textField.height = height;
         var textFormat:TextFormat = new TextFormat("Myriad Pro",int(fontSize),hexToDecimal(color));
         ...
         buttonSprite.x = this.loginMc.forgotPasswordButton.x;
         buttonSprite.y = this.loginMc.forgotPasswordButton.y;
         buttonSprite.addEventListener(MouseEvent.CLICK,this.openForgotPassword);
         return textField;
      }
      ...
      {
         var _loc1_:SharedObject = SharedObject.getLocal("stickempiresAcc");
         _loc1_.data.username = this.loginMc.loginBox.usernameInput.text.text;
         _loc1_.data.password = this.loginMc.loginBox.passwordInput.text.text;
         _loc1_.data.remstate = this.remState;
         trace("Saved username & password: ",this.loginMc.loginBox.usernameInput.text.text);
      }
      
      public function accSaveExists() : Boolean
      {
         var _loc1_:SharedObject = SharedObject.getLocal("stickempiresAcc");
         return _loc1_.data.username != "" && _loc1_.data.remstate > 0;
      }
      
      public function load() : void
      {
         var _loc1_:SharedObject = SharedObject.getLocal("stickempiresAcc");
         this.loginMc.loginBox.usernameInput.text.text = _loc1_.data.username;
         this.loginMc.loginBox.passwordInput.text.text = _loc1_.data.password;
         this.remState = _loc1_.data.remstate;
         if(remState == 1)
         {
            remtext.htmlText = "<p align=\"left\"><font color=\"#999999\" size=\'12\'>Remember Me - </font><font size=\'12\' color=\"#FFBB00\">Yes</font></p>";
         }
         else if(remState == 2)
         {
            remtext.htmlText = "<p align=\"left\"><font color=\"#999999\" size=\'12\'>Remember Me - </font><font size=\'12\' color=\"#00FF00\">Yes & Login</font></p>";
            this.btnConnectLogin(null);
         }
         trace("loaded " + _loc1_.data.username);
      }
