         ...
         if(this.chatOverlay.armourButton.hitTestPoint(stage.mouseX,stage.mouseY))
         {
            ...
            if(this.main.xml.xml.hasArmory == 1)
            {
               if(LeAutismo == false)
               {
                  ...
                  LeAutismo = true;
                  main.peepeepoopoo = true;
               }
               else
               {
                  main._marketScreen.updateMarketItems();
                  main.itemMap.loadItems(main);
                  main.oldArmorScreen.initUnitCards();
                  this.main.showScreen("oldArmoury");
                  LeAutismo = false;
                  main.peepeepoopoo = false;
               }
               this.main.soundManager.playSoundFullVolume("MenuTab");
