package com.brockw.stickwar
{
   ...
   public class Main extends BaseMain
   {
      ...
      public var _marketScreen:MarketScreen;
      
      private var _armourScreen:NewArmoryScreen;
      
      public var oldArmorScreen:ArmoryScreen;
      ...
      public function init() : void
      {
         ...
         this.oldArmorScreen = new ArmoryScreen(this);
         addScreen("oldArmoury",this.oldArmorScreen);
      ...
      private function receiveMarketItems(param1:SFSObject) : void
      {
         ...
         trace("marketItemsArray = " + marketItems);
         this._marketScreen.updateMarketItems();
         this.itemMap.loadItems(this);
         this.oldArmorScreen.updateUnitCard();
