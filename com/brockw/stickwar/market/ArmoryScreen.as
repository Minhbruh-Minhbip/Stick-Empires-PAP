package com.brockw.stickwar.market
{
   ...
   public class ArmoryScreen extends Screen
   {
      ...
      private var currentCard:OldArmoryUnitCard;
      ...
      {
         var _loc5_:OldArmoryUnitCard;
         (_loc5_ = new OldArmoryUnitCard(this.main,param1,param2,ItemMap.getUnitMcFromType(param2),param3,param4)).currentItemType = this.currentType;
      ...
      {
         var _loc2_:OldArmoryUnitCard = null;
         var _loc1_:int = 0;
      ...
      {
         var _loc1_:OldArmoryUnitCard = null;
         for each(_loc1_ in this.unitCards)
         {
            _loc1_.changeItemList();
         }
      }
      
      private function updateUnitCards(param1:Boolean = false) : void
      {
         var _loc3_:OldArmoryUnitCard = null;
      ...
      public function update(param1:Event) : void
      {
         var _loc3_:OldArmoryUnitCard = null;
         var _loc4_:int = 0;
         var _loc5_:OldArmoryUnitCard = null;
